...
static sk_sp<SkImageFilter> maskGradientBlur(sk_sp<SkImageFilter> blurFilter,
    ...
    SkColor4f colors[2] = {
            fadeInFromStart ? SkColor4f{0.f, 0.f, 0.f, 0.f} : SkColor4f{1.f, 1.f, 1.f, 1.f},
            fadeInFromStart ? SkColor4f{1.f, 1.f, 1.f, 1.f} : SkColor4f{0.f, 0.f, 0.f, 0.f},
    };
    SkGradient::Colors gradientColors(SkSpan<const SkColor4f>(colors, 2), SkTileMode::kClamp);
    SkGradient gradient(gradientColors, {});
    sk_sp<SkShader> maskShader = SkShaders::LinearGradient(points, gradient);
